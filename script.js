...
function clueCastleRoom() {
    ...
    switch (playersChoice) {
        case "look":
            ...
            break;
        case "orb":
            gameMainTextElem.innerHTML = `As you peer into its depths, the orb reveals all of Eldoria. A living mirror into the realm. The orb reflects not just places, but your entire journey.<br><br> You see your Village of Edune, where your journey began, a place that now feels so small compared to the trials that weigh upon you. Your gaze shifts to the Old Village, where the Pier hides the fisherman whose very existence threatened your life for the piece of the Bloodless Key. ${rooms["Forest"].isAreaActivityFinished ? "You see the obelisk within the Cave and the Forest outside of your Village with the very strange talking tree." : "You see the Forest outside of your Village, but you were unable to find the talking tree with a clue."} ${rooms["HiddenHut"].isAreaActivityFinished ? "You found the Hidden Hut and the mystery words inside, hinting at the Sphinx being in the Mountains" : "You unfortunately did not find the mystery within the Hidden Hut."} ${rooms["Field"].isAreaActivityExtraFinished ? "You see the Field once more, and the memory of the child you encountered there returns. You could not afford to take the risk in helping them, a choice that still lingers in your mind." : "You see the Field, and there, the haunting image of the demonic child you mistakenly chose to help. The regret of that choice still grips you, a chilling reminder of the danger lurking beneath innocence."}<br><br> Further on, the Cave system concealed within the Abandoned Building comes into view${rooms["MagicPath"].isAreaActivityExtraFinished ? ". You recall the old woman on the Magic Path, her hands worn but steady as she restored the damaged texts. It was through her magic that you uncovered the truth about the danger lurking within the cave." : ". You did not make use of the old womans power to restore texts on the Magic Path."} ${rooms["AbandonedBuilding"].wasSpellUsed ? "You had made an attempt to use a spell to restore the damaged texts" : "You decided not to take the risk on attempting to use a spell on the texts."} ${rooms["AbandonedBuilding"].didSpellFail ? "but it failed, leaving you to face the danger of the cave without the guidance you had hoped for." : ""} ${rooms["AbandonedBuilding"].didSpellSucceed ? "and you were successful, uncovering their hidden knowledge with ease. With the restoration complete, there was no need to seek out any other method." : ""} You rememeber managing to avoid death within the deceptive Cave chamber. You see the dragon pedestal resting at the Caves End, where yet another fragment was claimed after facing untold danger. Then you see yourself curing your poisoned body within the warmth of the Hot Springs, a brief respite after such chaos.<br><br>${rooms["StoneHouse"].isAreaActivityFinished && rooms["CaveEnd"].isAreaActivityFinished ? "You had discovered the woman in the Stone House, who revealed her harrowing tale of breaking free from Melkors service and she offered her guidance, eager to assist you in the battle against him." : "You had only stumbled upon the lifeless body of a woman in the Stone House, yet her identity and the purpose that brought her to that place remains shrouded in mystery, leaving you with unanswered questions."} ${rooms["RiverHouse"].isAreaActivityFinished ? "You found the clue referring to the Pier, hidden under the table in the River House." : "You did not find the clue about the Pier, which was hidden in the River House."} In the distance, the Sphinx looms in the mountains, ${rooms["Sphinx"].firstRiddleComplete ? "its deathly riddles still echoing in your mind." : "you did not take the risk in answering any of the Sphinx riddles and found the pieces on your own."} ${rooms["Sphinx"].allRiddlesComplete ? "You bravely answered every question the Sphinx had for you." : ""}<br><br> You then spy the Ruins that the Mysterious Town guarded. A town hiding another key fragment while still holding more secrets than it had ever revealed. ${rooms["BoneChurch"].isAreaActivityFinished ? "You see the Bone Church, its horrors etched into your memory, yet amidst the terror, there is a measure of solace in knowing that, at least you freed the mages soul from eternal damnation and received the clue." : "You see the Bone Church, its horrors etched into your memory, although sadly, you did not manage to free the mages soul from the jar found in the Magic House."}<br><br> Finally, you see Minas Ithil, the great Castle, standing tall against the landscape. Every path has led you here. Each challenge, every decision. You think of the dangers you have survived, the trials overcome. There were moments of doubt, of fear, but also of resolve. Now, standing in this room, staring into the mirror of your journey, one truth becomes clear. It is not over. Everything you have endured has brought you to this final confrontation. Time to finish what has been started.`;
            addHiddenClassTo(gameTextSecondaryOptionsElem);
            currentRoom.isAreaActivityFinished = true;
            break;
    }
